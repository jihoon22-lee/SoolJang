...
2026-09-07 사용자가 CI 통과 후 자율 머지와 v1.7.0 전체 구현·최종 릴리스/배포까지
승인했다. 검토/CI가 통과한 #116을 merge commit으로 머지하고 그 main을 #132에 통합했다.
이 통합으로 fast-uri 3.1.7이 반영됐으며 최신 head의 CI를 다시 확인한다. 최초 실패 기록은
당시 증거로 보존한다. 유료 가입·신규 credential 발급은 이 승인에 포함된 것으로 추정하지 않는다.
