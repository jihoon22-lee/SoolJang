...
import type { Bottle, BottleStatus, Product, Purchase, SourceLookupResult } from "@/api/types";
 ...
 */
function ExternalInfoCard({ productId, offline }: { productId: string; offline: boolean }) {
