...
| 항목 | 값 |
|---|---|
| 최종 갱신 | 2026-09-07 — B01/B02/B03/B04/B06/B08 CI 통과·머지. B05 실제 앱 탐색·Exa·모바일 및 보안 보강 검증 완료, PR 준비. B07 전체 통합 검사 완료·PR 준비 |
...
| 진행 중 잔여 항목 | B01/B02/B03/B04/B06 머지. B08 #138 CI 통과·머지. B05 검색/API·Exa6주종 실연결 검증, UI통합 진행. B07 목표가/감시·푸시 구현과 전체 통합 검사 완료, B09 통합 수용 후 릴리스·배포. 사용자 승인: 필수 CI 통과 후 자율 머지, 마일스톤 완료 후 릴리스·배포(2026-09-07). 유료 계약/신규 키 발급은 자동 수행하지 않음 |
