...
| 항목 | 값 |
|---|---|
| 최종 갱신 | 2026-09-07 — B01 #133·B02 #134·B03 #136·B04 #137·B06 #135 CI 통과·머지. B08 구현/로컬·실브라우저 검증 완료, PR 준비 |
...
| 현재 브랜치 | `feature/v170-data-inventory` — B08. 실제 재개 시 Git/열린 PR 및 분리 worktree 상태 확인 |
| 진행 중 잔여 항목 | B01/B02/B03/B04/B06 머지. B08 데이터 정리·관심 구매 전환·보관/실사 구현과 전체 로컬 검사·실브라우저 완료. B05 탐색·B07 목표가 구현, B09 통합 수용 후 릴리스·배포. 사용자 승인: 필수 CI 통과 후 자율 머지, 마일스톤 완료 후 릴리스·배포(2026-09-07). 유료 계약/신규 키 발급은 자동 수행하지 않음 |
