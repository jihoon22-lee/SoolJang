...
| 항목 | 값 |
|---|---|
| 최종 갱신 | 2026-09-07 — #116/#132 머지 완료. B01 #133·B02 #134·B03 #136 머지. B04 가격 비교·복구·실브라우저/전체 검사 완료, B06 #135 CI 통과·머지 |
...
| 진행 중 잔여 항목 | B01 #133·B02 #134·B03 #136·B06 #135 머지. B04 #137 B06 통합 검사 통과/새 CI 진행. B05 관심0016/최소API·Exa 실인증 완료, 탐색 서비스/UI 구현 중. B07 목표가·B08 데이터·재고 병행. 운영 수용은 B09에 남음. 사용자 승인: 필수 CI 통과 후 자율 머지, 마일스톤 완료 후 릴리스·배포(2026-09-07). 유료 계약/신규 키 발급은 자동 수행하지 않음 |
