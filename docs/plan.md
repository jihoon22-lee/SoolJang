...
| 항목 | 값 |
|---|---|
| 최종 갱신 | 2026-09-07 — B01~B09 CI 통과·머지. 사용자 승인 이연 #142/#143을 분리하고1.7.0 릴리스·운영 배포 완료 |
...
| 다음 착수 Task | **후속 #142/#143** — 허용된 국내 가격 실연결과 실제 HTTPS 기기 푸시 수용 |
| 현재 브랜치 | `feature/v170-deployment-record` — 배포 실행 기록. 실제 재개 시 Git/열린 PR 및 분리 worktree 상태 확인 |
...
| 버전 상태 | 패키지/태그/운영 API·web `1.7.0`, release SHA `f1c5bbc`, 실제 schema `0018_price_watch`, API/web/db healthy. 직전·전환 후 백업과 격리 복원 확인 완료 |
...
| B03 / WP05 | 🟡 #136 CI 통과·머지, 실제 Exa 인증·앱 탐색 통과(나머지는 선택형 미검증) | [기록](../workthrough/2026-09-07-v170-b03-connections.md) |
...
| B09 / WP13 | 🟡 최종 격리 검증·#141 CI/머지, #144 버전/릴리스·운영 전환 완료 | [수용 원장](plans/v1.7.0/acceptance.md), [기록](../workthrough/2026-09-07-v170-b09-acceptance.md) |
