> 현재 패치는 **v1.7.1**이다. 구매 가격 공란은 0원이며 빈티지는 등록 필드를 우선한다.
> [패치 기록](../workthrough/2026-09-07-v171-price-vintage.md)과
> [실제 릴리스·배포 결과](https://github.com/jihoon22-lee/SoolJang/releases/tag/v1.7.1)를 먼저 확인한다.
> 아래 v1.7.0 운영 기록은 직전 배포의 검증 이력이다. 스키마는 동일한0018이다.
...
- 2026-09-07: B01~B08 PR #133~#140은 필수 CI 통과·머지. B09는 첨부 열람·최종 복구/
  브라우저/성능·Docker 검증을 통합했다. 현재 [수용 원장](plans/v1.7.0/acceptance.md)과
  [B09 기록](../workthrough/2026-09-07-v170-b09-acceptance.md)에서 SHA·환경·실행 제한을 확인한다.
  국내 가격 2출처와 실제 기기 푸시 수용은 사용자 승인으로 #142/#143에 이연했다. 1.7.0 릴리스·운영 배포를 완료했고 [릴리스 기록](../workthrough/2026-09-07-v170-release.md)에 실제 전환을 남긴다. 최종 운영 확인은
  1.7.0/schema0018, release SHA `f1c5bbc`, 세 컨테이너 healthy다. 최신 백업·격리 복원·HTTPS 앱과 Exa를 확인했다. 아래 "다음 작업 없음"과 수치는 과거 이력이다.
