...
- 2026-09-07: B01~B08 PR #133~#140은 필수 CI 통과·머지. B09는 첨부 열람·최종 복구/
  ...
  국내 가격 2출처와 실제 기기 푸시 수용은 사용자 승인으로 #142/#143에 이연했다. 구현된1.7.0 릴리스·배포를 진행하며 [릴리스 기록](../workthrough/2026-09-07-v170-release.md)에 실제 전환을 남긴다. 운영 readonly 확인은
  1.6.1/schema0012이며 태그·운영 변경은 아직 없다. 아래 "다음 작업 없음"과 수치는 과거 이력이다.
